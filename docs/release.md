...
Binaries for bellcoind are distributed for convenience and built deterministically with Gitian, signatures for bellcoind are located at the [gitian.sigs](https://github.com/bitpay/gitian.sigs) respository.
