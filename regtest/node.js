...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.bellcoind.height === 150) {
            node.services.bellcoind.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.bellcoind.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('bellcoind/hashblock', function(data) {
        bus.unsubscribe('bellcoind/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.bellcoind.height;
      node.services.bellcoind.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.bellcoind.sendTransaction(tx.serialize(), function(err, hash) {
