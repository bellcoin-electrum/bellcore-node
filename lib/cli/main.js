...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bellcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bellcore-node add wallet-service');
      console.log('    $ bellcore-node add insight-api-bellcoin');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bellcore-node remove wallet-service');
      console.log('    $ bellcore-node remove insight-api-bellcoin');
      console.log();
    });
